...
function resetDailyEntrySheet() {
  ...
  // Clear recent transactions log DATA ONLY (not the header) - exactly 3 rows of data (A28:I30)
  dailyEntrySheet.getRange("A28:I30").clearContent();
...
function setupDailyEntrySheet(ss) {
  ...
  const recentLogFormula = `=IFERROR(QUERY('${CONFIG.sheets.masterLog}'!A:L, "SELECT G, D, E, F, H, I, J WHERE L = 'ACTIVE' ORDER BY B DESC LIMIT 3 LABEL G 'Payment', D 'Masseuse', E 'Service', F 'Amount', H 'Fee', I 'Start', J 'End'", 1), "No transactions yet.")`;
