        ...
        const results = await page.evaluate(() => {
            ...
            try {
                ...
                scripts.forEach((script, index) => {
                    ...
                    if (tryMatches) {
                        tryBlocks.push({ script: index, count: tryMatches.length, content: content });
