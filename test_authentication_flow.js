...
describe('Authentication and Session Management Flow', function() {
    ...
    describe('GET /api/main/transaction (Unauthenticated Browser)', function() {
        it('should redirect to /login.html with a 302 status', function(done) {
            request
    ...
    describe('GET /api/main/transaction (Unauthenticated API)', function() {
        it('should return a 401 Unauthorized with a JSON error', function(done) {
            request
                .get('/api/main/transaction')
    ...
    describe('POST /api/auth/login', function() {
        it('should return 200, user data, and set a long-lived session cookie', function(done) {
            agent
                .post('/api/auth/login')
    ...
    describe('GET /api/main/transaction (Authenticated)', function() {
        it('should return 200 OK and the page content', function(done) {
    ...
    describe('POST /api/auth/logout', function() {
        it('should return 200 and clear the session cookie', function(done) {
            agent
    ...
    describe('GET /api/main/transaction (After Logout)', function() {
