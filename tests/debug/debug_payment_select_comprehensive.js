  ...
  try {
    ...
    const results = await page.evaluate(() => {
      ...
      try {
        ...
        return {
          ...
          counts: {
            const: constPaymentSelectCount, let: letPaymentSelectCount, var: varPaymentSelectCount, noKeyword: noKeywordPaymentSelectCount
          }
        };
      } catch (error) {
    ...
    const hypothesis2Results = await page.evaluate(() => {
      ...
      try {
        ...
        const paymentSelectDeclarations = [];
    ...
    const hypothesis4Results = await page.evaluate(() => {
      ...
      try {
        ...
        const scripts = document.querySelectorAll('script');
        const globalScopeDeclarations = [];
        const functionScopeDeclarations = [];
