...
test('remove button works without crashes and repopulates dropdown', async ({ page }) => {
  const consoleErrors = [];
  const pageErrors = [];
  ...
  // Test that renderDropdown can handle undefined without crashing
  await page.evaluate(() => {
    // This should not throw
    renderDropdown(undefined, undefined);
